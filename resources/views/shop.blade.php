                            ...
                            <div class="latest-prdouct__slider__item">
                                <a href="{{ route('detalles', 'id=' . $item->id . '') }}" class="latest-product__item">
                                    ...
                                    <div class="latest-product__item__text">
                                        <h6>{{ $item->nombre }}</h6>
                                        <span>{{ $_COOKIE['moneda'] === 'usd' ? "$ " . $item->preciousd : "€ " . $item->preciousd * $exchangeRate }}</span>
                                    </div>
                                </a>
                            </div>
                        @endforeach
                                ...
                                <div class="product__item">
                                    <div class="product__item__pic set-bg" data-setbg="{{ $item->foto }}">
                                        ...
                                        <ul class="product__item__pic__hover">
                                            <li><a href="{{ route('detalles', 'id=' . $item->id . '') }}"><i
                                                        class="fa fa-info-circle"></i></a></li>
                                            @auth
                                                <li><a
                                                        href="javascript:document.getElementById('addCartForm_{{ $item->id }}').submit()"><i
