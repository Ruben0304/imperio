...
<body style="--main-bg-color:  {{ $color }}">
    ...
    <div class="humberger__menu__wrapper">
        <div class="humberger__menu__logo">
            <a href="#"><img src="img/logolargonegro.png" alt=""></a>
        </div>
        <div class="humberger__menu__cart">
            <ul>
                @auth
                    ...
                    <li><a href="{{ route('carrito') }}"><i class="fa fa-shopping-bag"></i>
        ...
        <div class="humberger__menu__contact">
            <ul>
                <li><i class="fa fa-envelope"></i> elcorreo@gmail.com</li>
                {{-- <li>Envios gratis a partir de 5000 cup (ejemplo)</li> --}}
            </ul>
        </div>
    </div>
    <!-- Humberger End -->
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__left">
                            <ul>
                                ...
                                <li>Aqui va algo</li>
                                <li>
                                    <form action="{{ route('cambiar_color') }}" method="post"> @csrf @method('put')
                        ...
                        <div class="header__top__right">
                            ...
                            <div class="header__top__right__language">
                                ...
                                @if (isset($_COOKIE['moneda']))
                                    ...
                                    @if ($_COOKIE['moneda'] == 'usd')
                                        <div style="display: inline"><i class="fa fa-dollar"></i><span
                                                style="margin-left: 10px">USD</span></div>
                                    @else
                                        <div style="display: inline"><i class="fa fa-dollar"></i><span
                                                style="margin-left: 10px">EUR</span></div>
                                    @endif
                                @else
                                    <div style="display: inline"><i class="fa fa-dollar"></i><span
                                            style="margin-left: 10px">USD</span></div>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header__logo">
                        ...
                        <a href="{{ route('home') }}"><img src="img/logolargonegro.png" alt=""></a>
